...
def read_data_file(file_path: str, source_schema: Optional[SchemaDefinition] = None) -> pl.DataFrame:
    """
    Enhanced reader for data files with automatic struct flattening
    and source schema validation.
